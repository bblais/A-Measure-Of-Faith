...
Now that we have the structure and notation of probabilities, we can address a number of related terms.  We start with {\em belief}. \TODO{more on belief needed}
\begin{quote}
